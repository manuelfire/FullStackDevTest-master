...
export const IMAPfetchOne = (id,config) => axios.get(`${url}/imap/getEmail`,{ params: { uid: id }}); 
export const POP3fetchAll = (config) => axios.patch(`${url}/pop3/getAllEmails`,config);
export const POP3fetchOne = (id ,config) => axios.post(`${url}/pop3/getEmail`,{ params: { uid: id }});